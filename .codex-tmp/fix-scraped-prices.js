...
function buildPackagesJson(basePrice) {
...
async function main() {
    ...
    for (const trainer of scraped) {
        ...
        console.log(`Updated: ${trainer.name} (${trainer.city}) | Rating: ${trainer.rating ?? "N/A"} -> Rs ${basePrice} + Rs ${platformFee} fee = Rs ${totalPrice}`);
        updated++;
    }
