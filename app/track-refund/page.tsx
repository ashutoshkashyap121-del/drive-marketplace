      ...
      <div style={{ width: "100%", maxWidth: 460 }}>
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <p style={{ color: "#64748B", fontSize: "0.88rem", marginTop: 8 }}>
            Check eligibility and submit your refund request
          </p>
        </div>
        ...
        >
            ...
            <>
              ...
              >
                ...
                <p style={{ margin: "4px 0", color: "#555", fontSize: "0.88rem" }}>
                  Amount: <strong style={{ color: "#F59E0B" }}>Rs {bookingInfo.amount?.toLocaleString("en-IN")}</strong>
                </p>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <textarea
                  ...
                  placeholder="e.g. Booking was not confirmed, trainer did not call..."
                  rows={3}
              ...
              >
                This will cancel your booking and initiate a full refund of{" "}
                <strong>Rs {bookingInfo.amount?.toLocaleString("en-IN")}</strong>. Refunds take 5-7 business days.
              </div>
          ...
          {step === "done" && result && (
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ color: "#555", fontSize: "0.88rem", lineHeight: 1.7, marginBottom: 20 }}>{result.message}</p>
              {result.refundId && (
                <div
                  style={{
                    background: "#F0FDF4",
