...
// ============================================================
// REPLACE "LearnDrive" with your brand name when decided
// ============================================================
...
const STEPS = [
  {
    ...
    desc: "Select your city and whether you want car or bike training.",
    icon: "📍",
  },
  {
    number: "02",
    title: "Pick a Verified Trainer",
    desc: "Browse RTO-verified trainers with real reviews and transparent pricing.",
    icon: "👨‍🏫",
  },
  {
    number: "03",
    title: "Book & Pay Safely",
    desc: "Book your slot, pay via UPI or EMI. Trainer comes to your location.",
    icon: "✅",
  },
];
const TRUST = [
  {
    icon: "🏛️",
    title: "RTO Verified Trainers",
    desc: "Every trainer is verified with the Regional Transport Office. No unregistered instructors ever.",
  },
  {
    icon: "🔍",
    title: "Background Checked",
    desc: "Police verification and background screening done before any trainer is listed.",
  },
  {
    icon: "👩",
    title: "Female-Friendly Trainers",
    desc: "Choose a female trainer or a trainer trained in female-student etiquette.",
  },
  {
    icon: "🏠",
    title: "Pickup from Home or Office",
    desc: "Trainer arrives at your doorstep. No auto-rickshaw to a distant training centre.",
  },
  {
    icon: "🗣️",
    title: "Hindi & Regional Language Support",
    desc: "Learn in Hindi, Kannada, Marathi — whatever you're comfortable with.",
  },
  {
    icon: "💳",
    title: "EMI & Pay Later",
    desc: "Split your course fee into easy monthly instalments. Start driving, pay slowly.",
  },
];
...
export default function HomePage() {
  ...
  const handleFind = () => {
    ...
    router.push(`/trainers?city=${encodeURIComponent(city)}&vehicle=${vehicle}`);
  };
    ...
    >
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .trust-card:hover, .trust-card.hovered {
          border-color: #F59E0B;
      ...
      >
        <div className="brand-name">
          Learn<span>Drive</span>
          {/* ↑ Replace "LearnDrive" with your brand name */}
        </div>
      ...
      <section
        ...
        style={{ padding: "120px 5% 60px", minHeight: "100vh", display: "flex", alignItems: "center" }}
      >
        <div
          style={{
            maxWidth: 1100,
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.65)", marginTop: 20, fontSize: "1rem", lineHeight: 1.7, maxWidth: 460 }}>
              Book professional car & bike training in Delhi NCR, Mumbai, and Bangalore.
              Trainer comes to your home. Pay via UPI or EMI.
            </p>
            ...
            >
              {STATS.map((s) => (
                <div key={s.label} className="stat-item" style={{ paddingLeft: 0, textAlign: "left" }}>
          ...
          <div>
            <div className="search-card">
              <p style={{ fontSize: "1.05rem", fontWeight: 700, color: "#0F172A", marginBottom: 22 }}>
                Find a Trainer Today
              </p>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h2 className="section-title">
              Built for India.<br />Built for Trust.
            </h2>
          ...
          <div className="trust-grid">
            {TRUST.map((item, i) => (
              <div
                key={item.title}
                className={`trust-card ${hoveredTrust === i ? "hovered" : ""}`}
      ...
      >
        ...
        <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: 28, fontSize: "0.95rem" }}>
          Join thousands of learners across Delhi NCR, Mumbai & Bangalore.
        </p>
        <a
          href="/trainers"
          style={{
      ...
      <footer className="footer-bar">
        <div style={{ marginBottom: 10 }}>
          ...
          <a href="/admin">For Driving Schools</a>
        </div>
        {/* Replace LearnDrive with your brand name below */}
