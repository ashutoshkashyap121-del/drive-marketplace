          ...
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }}>
              {topics.map(([topicKey, meta]) => {
                ...
                return (
                  <button key={topicKey} onClick={() => startTopic(topicKey)} className="topic-card jk" style={{ all: "unset", display: "block", background: "white", borderRadius: 14, padding: 24, border: "2px solid #e2e8f0", cursor: "pointer", transition: "all 0.2s" }}
          ...
          <div style={{ maxWidth: 560, margin: "0 auto", textAlign: "center" }}>
            <div style={{ background: "white", borderRadius: 20, padding: 40, boxShadow: "0 8px 40px rgba(0,0,0,0.1)", marginBottom: 24 }}>
                ...
                {quizQuestions.map((q, i) => (
                  <div key={q.id} style={{ display: "flex", alignItems: "flex-start", gap: 10, padding: "10px 0", borderBottom: "1px solid #f1f5f9" }}>
                    ...
                    <div>
                      ...
                      {answers[i] !== q.correct && (
                        <p className="jk" style={{ fontSize: 12, color: "#16a34a", marginTop: 2 }}>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
                <button onClick={() => activeTopic && startTopic(activeTopic)} className="jk" style={{ padding: "12px 24px", background: "#1d4ed8", color: "white", border: "none", borderRadius: 10, fontWeight: 700, cursor: "pointer", fontSize: 14, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  Try Again
                </button>
                <button onClick={() => setScreen("home")} className="jk" style={{ padding: "12px 24px", background: "#f1f5f9", color: "#0f172a", border: "none", borderRadius: 10, fontWeight: 700, cursor: "pointer", fontSize: 14, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  Choose Topic
                </button>
              </div>
            </div>
