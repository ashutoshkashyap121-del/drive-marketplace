...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Find and book verified driving schools in ${data.displayName}, ${data.city}. Compare prices and ratings. Starting from ₹5,500. Instant online booking on LearnDrive.`;
  ...
  return {
    ...
    openGraph: { title, description, url: `https://learndrive.in/driving-schools-in-${area}`, siteName: "LearnDrive", locale: "en_IN", type: "website" },
    ...
    <main style={{ minHeight: "100vh", background: "#F8F7F4", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "28px 24px" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #E2E8F0", padding: "24px 28px", marginBottom: 24 }}>
          <h2 style={{ fontFamily: "'Sora',sans-serif", fontSize: 16, color: "#0F172A", marginBottom: 10 }}>
            Driving Schools Near {localityData.displayName}
          </h2>
          <p style={{ color: "#555", fontSize: 14, lineHeight: 1.9 }}>
            LearnDrive lists verified driving schools in {localityData.displayName} and nearby areas in {localityData.city}. Compare prices, check ratings and book your first driving session online. DL packages start from ₹5,500 with transparent pricing and no hidden charges.
          </p>
        </div>
      </div>
    </main>
